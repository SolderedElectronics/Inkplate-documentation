...
.. image:: images/PCALvsMCP.png
    :width: 500

| IO Expander PORTB pins from P1-1 to P1-7 (or GPB1 - GPB7 on older Inkplates) can be used.
| DO NOT USE P0-0 - P0-7 and P1-0. In code those are pins from 0-8.
| Using those, you might permanently damage the screen.
| You should only use pins from 9 to 15.
| Remember! GPA0 = 0, GPA1 = 1, ..., GPA7 = 7, GPB0 = 8, GBP1 = 9, ..., GPB7 = 15.
| And also P0-0 = GPA0, P0-1 = GPA1, ..., P0-7 = GPA7, P1-0 = GPB0, P1-1 = GPB1, ..., P1-7 = GPB7.

| Port A is used for epaper panel and TPS65186 PMIC. P1-0 is used for ESP32 GPIO0 so you can't use it either.
